...
// Command-line arguments: test example/fib.dfy /Users/Sofia/DafnyFaultLoc/coverage/src/CoverageRuntime.cs /Users/Sofia/DafnyFaultLoc/coverage/src/CoverageExtern.dfy --plugin /Users/Sofia/DafnyFaultLoc/coverage/src/bin/Release/net8.0/DafnyTestCoverage.dll --no-verify
// the_program
...
namespace _module {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      if (CoverageRuntime.CheckDepth(new BigInteger(1000))) {
        if ((n).Sign == 0) {
    ...
    public static BigInteger FactorialOfLastDigit(BigInteger n)
    {
      ...
      if (!(CoverageRuntime.CheckDepth(new BigInteger(1000)))) {
        throw new Dafny.HaltException("example/fib.dfy(13,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Infinite recursion blocked by test coverage plugin").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COVERAGE_LINE: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((new BigInteger(17)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _0_lastDigit;
      _0_lastDigit = (BigInteger.Zero) - (Dafny.Helpers.EuclideanModulus(n, new BigInteger(10)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COVERAGE_LINE: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((new BigInteger(18)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    ...
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(21,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test0 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(4)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(22,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(4));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(4), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(24,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test1()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(26,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test1 ---\n")).ToVerbatimString(false));
      if (!((BigInteger.Zero).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(27,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(BigInteger.Zero);
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(BigInteger.Zero, new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(29,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test2()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(31,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test2 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(100)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(32,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(100));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(100), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(34,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test4()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(36,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test4 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(5)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(37,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(5));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(5), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(39,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test5()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(41,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test5 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(62834)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(42,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(62834));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(62834), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(44,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test7()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(49,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test7 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(62835)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(50,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(62835));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(62835), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(52,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test8()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(57,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test8 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(62836)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(58,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(62836));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(62836), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(60,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test9()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(65,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test9 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(62837)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(66,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(62837));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(62837), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(68,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void Test10()
    {
      if (!(CoverageRuntime.Reset())) {
        throw new Dafny.HaltException("example/fib.dfy(73,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("State reset").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--- RUNNING TEST: Test10 ---\n")).ToVerbatimString(false));
      if (!((new BigInteger(62838)).Sign != -1)) {
        throw new Dafny.HaltException("example/fib.dfy(74,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the preconditions").ToVerbatimString(false));}
      BigInteger _0_r0;
      BigInteger _out0;
      _out0 = __default.FactorialOfLastDigit(new BigInteger(62838));
      _0_r0 = _out0;
      if (!((_0_r0) == (__default.Factorial(Dafny.Helpers.EuclideanModulus(new BigInteger(62838), new BigInteger(10)))))) {
        throw new Dafny.HaltException("example/fib.dfy(76,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void __Test____Main__(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      bool _0_success;
      _0_success = true;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test0: ")).ToVerbatimString(false));
      try {
        {
          __default.Test0();
          {
...
")).ToVerbatimString(false));
      ...
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test1: ")).ToVerbatimString(false));
      try {
        {
          __default.Test1();
          {
...
")).ToVerbatimString(false));
        ...
        var _2_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_2_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test2: ")).ToVerbatimString(false));
      try {
        {
          __default.Test2();
          {
...
")).ToVerbatimString(false));
        ...
        var _3_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_3_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test4: ")).ToVerbatimString(false));
      try {
        {
          __default.Test4();
          {
...
")).ToVerbatimString(false));
        ...
        var _4_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_4_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test5: ")).ToVerbatimString(false));
      try {
        {
          __default.Test5();
          {
...
")).ToVerbatimString(false));
        ...
        var _5_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_5_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test7: ")).ToVerbatimString(false));
      try {
        {
          __default.Test7();
          {
...
")).ToVerbatimString(false));
        ...
        var _6_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_6_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test8: ")).ToVerbatimString(false));
      try {
        {
          __default.Test8();
          {
...
")).ToVerbatimString(false));
        ...
        var _7_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_7_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test9: ")).ToVerbatimString(false));
      try {
        {
          __default.Test9();
          {
...
")).ToVerbatimString(false));
        ...
        var _8_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_8_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test10: ")).ToVerbatimString(false));
      try {
        {
          __default.Test10();
          {
...
")).ToVerbatimString(false));
        ...
        var _9_haltMessage = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"FAILED
	")).ToVerbatimString(false));
          Dafny.Helpers.Print((_9_haltMessage).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"
")).ToVerbatimString(false));
          _0_success = false;
        }
      ...
      if (!(_0_success)) {
        throw new Dafny.HaltException("example/fib.dfy(3,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test failures occurred: see above.
").ToVerbatimString(false));}
    }
  }
