...
var r0 := RotateLeftBits((536870912 as bv32), 3);
expect r0 == ((536870912 as bv32) << 3 as bv6) | ((536870912 as bv32) >> (32 - 3) as bv6);
}

// REPEAT 5 - TIME: 5.5108417 s

method {:test} Test5() {
expect 0 <= 4 < 32, "If this check fails at runtime, the test does not meet the preconditions";
var r0 := RotateLeftBits((2684354560 as bv32), 4);
expect r0 == ((2684354560 as bv32) << 4 as bv6) | ((2684354560 as bv32) >> (32 - 4) as bv6);
}

// REPEAT 6 - TIME: 6.4511744 s

method {:test} Test6() {
expect 0 <= 6 < 32, "If this check fails at runtime, the test does not meet the preconditions";
var r0 := RotateLeftBits((1610612736 as bv32), 6);
expect r0 == ((1610612736 as bv32) << 6 as bv6) | ((1610612736 as bv32) >> (32 - 6) as bv6);
}

// REPEAT 7 - TIME: 7.3221667 s

method {:test} Test7() {
expect 0 <= 5 < 32, "If this check fails at runtime, the test does not meet the preconditions";
var r0 := RotateLeftBits((3758096384 as bv32), 5);
expect r0 == ((3758096384 as bv32) << 5 as bv6) | ((3758096384 as bv32) >> (32 - 5) as bv6);
}

// REPEAT 8 - TIME: 8.0128677 s
